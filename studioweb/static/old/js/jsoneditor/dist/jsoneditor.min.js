...
!function (e, t) {
    ...
    return function (e) {
        ...
        }, e.exports = [{mode: "tree", mixin: c, data: "json"}, {mode: "view", mixin: c, data: "json"}, {
            mode: "form",
            mixin: c,
            data: "json"
        }]
        ...
        a.create = function (e, t) {
            ...
            if (this.content = document.createElement("div"), this.content.className = "outer", this.frame.appendChild(this.content), this.container.appendChild(this.frame), "code" == this.mode) {
                ...
                }, this.menu.appendChild(h), t.change && c.on("change", function () {
                    t.change()
                })
            } else {
        ...
        n.prototype._updateEditability = function () {
            ...
            if (n.focusElement = e, this.dom.tr && this.dom.tr.parentNode) {
                ...
                switch (e) {
                    ...
                    case"expand":
                        ...
                        break;
                    case"field":
                        t.field && this.fieldEditable ? (t.field.focus(), s.selectContentEditable(t.field)) : t.value && !this._hasChilds() ? (t.value.focus(),
            ...
            var o = this.editor.getSelection(), r = new n(this.editor, {
                field: void 0 != e ? e : "",
                value: void 0 != t ? t : "",
                type: i
            });
        ...
        !function () {
            ...
            }, n = void 0 === i.exec.call(/()??/, "")[1], o = function () {
                var e = /^/g;
            ...
            o && n || (RegExp.prototype.exec = function (r) {
                ...
                if ("string" == typeof r && l) {
                    if (!n && l.length > 1 && t(l, "") > -1 && (a = RegExp(this.source, i.replace.call(e(this), "g", "")), i.replace.call(r.slice(l.index), a, function () {
                        ...
                        })), this._xregexp && this._xregexp.captureNames)for (var c = 1; c < l.length; c++)s = this._xregexp.captureNames[c - 1], s && (l[s] = l[c]);
            ...
            Function.prototype.bind || (Function.prototype.bind = function (t) {
                ...
                var n = u.call(arguments, 1), o = function () {
            ...
            var n, o, r, s, a, l = Function.prototype.call, c = Array.prototype, h = Object.prototype, u = c.slice, d = l.bind(h.toString), g = l.bind(h.hasOwnProperty);
            if ((a = g(h, "__defineGetter__")) && (n = l.bind(h.__defineGetter__), o = l.bind(h.__defineSetter__), r = l.bind(h.__lookupGetter__), s = l.bind(h.__lookupSetter__)), 2 != [1, 2].splice(0).length)if (function () {
                    function e(e) {
                        var t = new Array(e + 2);
                        return t[0] = t[1] = 0, t
                    }
                ...
                var n = this.slice(e, e + t), o = u.call(arguments, 2), r = o.length;
                if (e === i)r && this.push.apply(this, o); else {
                    ...
                    if (r && e === h)this.length = h, this.push.apply(this, o); else for (this.length = h + r, d = 0; r > d; ++d)this[e + d] = o[d]
                }
                return n
            };
            ...
            if (Array.prototype.forEach || (Array.prototype.forEach = function (e) {
                    var t = R(this), i = m && "[object String]" == d(this) ? this.split("") : t, n = arguments[1], o = -1, r = i.length >>> 0;
                    if ("[object Function]" != d(e))throw new TypeError;
                    for (; ++o < r;)o in i && e.call(n, i[o], o, t)
                }), Array.prototype.map || (Array.prototype.map = function (e) {
                    var t = R(this), i = m && "[object String]" == d(this) ? this.split("") : t, n = i.length >>> 0, o = Array(n), r = arguments[1];
                    if ("[object Function]" != d(e))throw new TypeError(e + " is not a function");
                    for (var s = 0; n > s; s++)s in i && (o[s] = e.call(r, i[s], s, t));
                    return o
                }), Array.prototype.filter || (Array.prototype.filter = function (e) {
                    var t, i = R(this), n = m && "[object String]" == d(this) ? this.split("") : i, o = n.length >>> 0, r = [], s = arguments[1];
                    if ("[object Function]" != d(e))throw new TypeError(e + " is not a function");
                    for (var a = 0; o > a; a++)a in n && (t = n[a], e.call(s, t, a, i) && r.push(t));
                    return r
                }), Array.prototype.every || (Array.prototype.every = function (e) {
                    var t = R(this), i = m && "[object String]" == d(this) ? this.split("") : t, n = i.length >>> 0, o = arguments[1];
                    if ("[object Function]" != d(e))throw new TypeError(e + " is not a function");
                    ...
                    var t = R(this), i = m && "[object String]" == d(this) ? this.split("") : t, n = i.length >>> 0;
                    if ("[object Function]" != d(e))throw new TypeError(e + " is not a function");
                    ...
                    var t = m && "[object String]" == d(this) ? this.split("") : R(this), n = t.length >>> 0;
                    if (!n)return -1;
                    var o = 0;
            ...
            if (Object.defineProperty) {
                ...
                if (!w || !C)var E = Object.defineProperty
            }
            if (!Object.defineProperty || E) {
                var F = "Property description must be an object: ", y = "Object.defineProperty called on non-object: ", b = "getters & setters can not be defined on this javascript engine";
            ...
            if (Object.preventExtensions || (Object.preventExtensions = function (e) {
                ...
                var S = !0, $ = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], B = $.length;
                for (var D in{toString: null})S = !1;
            ...
            if (!String.prototype.trim || k.trim()) {
                k = "[" + k + "]";
                var L = new RegExp("^" + k + k + "*"), _ = new RegExp(k + k + "*$");
                String.prototype.trim = function () {
                    return String(this).replace(L, "").replace(_, "")
                }
            }
            var R = function (e) {
            ...
            "use strict";
            var i = e("../lib/event"), n = e("../lib/useragent"), o = e("../lib/dom"), r = e("../lib/lang"), s = n.isChrome < 18, a = n.isIE, l = function (e, t) {
                function l(e) {
                    if (!p) {
                ...
                var $ = function () {
                    g ? g = !1 : F(u) ? (t.selectAll(), l()) : B && l(t.selection.isEmpty())
                }, B = null;
                ...
                var D = !1, k = function (e) {
                    B && (e = B(e), B = null), f ? (l(), e && t.onPaste(e), f = !1) : e == d.charAt(0) ? D ? t.execCommand("del", {source: "ace"}) : t.execCommand("backspace", {source: "ace"}) : (e.substring(0, 2) == d ? e = e.substr(2) : e.charAt(0) == d.charAt(0) ? e = e.substr(1) : e.charAt(e.length - 1) == d.charAt(0) && (e = e.slice(0, -1)), e.charAt(e.length - 1) == d.charAt(0) && (e = e.slice(0, -1)), e && t.onTextInput(e)), D && (D = !1)
                }, L = function () {
                    if (!p) {
                        var e = u.value;
                        k(e), c()
                    ...
                    var o = t.getCopyText();
                    return o ? void(_(e, o) ? (n ? t.onCut() : t.onCopy(), i.preventDefault(e)) : (g = !0, u.value = o, u.select(), setTimeout(function () {
                ...
                i.addCommandKeyListener(u, t.onCommandKey.bind(t)), i.addListener(u, "select", $), i.addListener(u, "input", L), i.addListener(u, "cut", T), i.addListener(u, "copy", M), i.addListener(u, "paste", O), "oncut"in u && "oncopy"in u && "onpaste"in u || i.addListener(e, "keydown", function (e) {
                ...
                i.addListener(u, "compositionstart", N), n.isGecko ? i.addListener(u, "text", function () {
                    ...
                    D = !0, l(t.selection.isEmpty()), t._emit("nativecontextmenu", {
                        target: t,
                        domEvent: e
            ...
            function i(e) {
                function t() {
                    ...
                    if (d != n)if (d = n.text.join("<br/>"), c.setHtml(d), c.show(), a.on("mousewheel", i), e.$tooltipFollowsMouse)r(u); else {
            ...
            function i(e) {
                function t(e, t) {
                    var i = Date.now(), o = !t || e.row != t.row, r = !t || e.column != t.column;
                    if (!B || o || r)m.$blockScrolling += 1, m.moveCursorToPosition(e), m.$blockScrolling -= 1, B = i, D = {
                        x: C,
                        y: E
                    }; else {
                        var s = n(D.x, D.y, C, E);
                ...
                function i(e, t) {
                    var i = Date.now(), n = m.renderer.layerConfig.lineHeight, o = m.renderer.layerConfig.characterWidth, r = m.renderer.scroller.getBoundingClientRect(), s = {
                        x: {
                            left: C - r.left,
                            right: r.right - C
                        }, y: {top: E - r.top, bottom: r.bottom - E}
                    }, l = Math.min(s.x.left, s.x.right), c = Math.min(s.y.top, s.y.bottom), h = {
                        row: e.row,
                        column: e.column
                    };
                    ...
                    u || d && !g ? $ ? i - $ >= a && m.renderer.scrollCursorIntoView(h) : $ = i : $ = null
                }
                ...
                function u() {
                    y = m.selection.toOrientedRange(), w = m.session.addMarker(y, "ace_selection", m.getSelectionStyle()), m.clearSelection(), m.isFocused() && m.renderer.$cursorLayer.setBlinking(!1), clearInterval(F), h(), F = setInterval(h, 20), L = 0, r.addListener(document, "mousemove", g)
                }

                function d() {
                    clearInterval(F), m.session.removeMarker(w), w = null, m.$blockScrolling += 1, m.selection.fromOrientedRange(y), m.$blockScrolling -= 1, m.isFocused() && !S && m.renderer.$cursorLayer.setBlinking(!m.getReadOnly()), y = null, b = null, L = 0, $ = null, B = null, r.removeListener(document, "mousemove", g)
                }
                ...
                function p(e) {
                    var t = ["copy", "copymove", "all", "uninitialized"], i = ["move", "copymove", "linkmove", "all", "uninitialized"], n = s.isMac ? e.altKey : e.ctrlKey, o = "uninitialized";
                    try {
                ...
                this.onDragStart = function (e) {
                    ...
                    return !m.getReadOnly() && f(e.dataTransfer) ? (C = e.clientX, E = e.clientY, w || u(), L++, e.dataTransfer.dropEffect = x = p(e), r.preventDefault(e)) : void 0
                }, this.onDragOver = function (e) {
                    return !m.getReadOnly() && f(e.dataTransfer) ? (C = e.clientX, E = e.clientY, w || (u(), L++), null !== _ && (_ = null), e.dataTransfer.dropEffect = x = p(e), r.preventDefault(e)) : void 0
                }, this.onDragLeave = function (e) {
                    return L--, 0 >= L && w ? (d(), x = null, r.preventDefault(e)) : void 0
            ...
            "use strict";
            var i = e("../lib/event"), n = e("../lib/useragent"), o = e("./default_handlers").DefaultHandlers, r = e("./default_gutter_handler").GutterHandler, s = e("./mouse_event").MouseEvent, a = e("./dragdrop_handler").DragdropHandler, l = e("../config"), c = function (e) {
                var t = this;
            ...
            (function () {
                this.isEqual = function (e) {
                    ...
                    if (this.start.row > t)var o = {row: t + 1, column: 0}; else if (this.start.row < e)var o = {
                        row: e,
                        column: 0
                    };
                    ...
                    if (0 == i)return this;
                    if (-1 == i)var o = {row: e, column: t}; else var r = {row: e, column: t};
                ...
                this.$setMaxTokenCount = function (e) {
                    ...
                    for (var l, c = [], h = 0, u = 0, d = {type: null, value: ""}; l = a.exec(e);) {
                        ...
                        for (var A = 0; A < l.length - 2; A++)if (void 0 !== l[A + 1]) {
                            f = r[s[A]], g = f.onMatch ? f.onMatch(p, o, n) : f.token, f.next && (o = "string" == typeof f.next ? f.next : f.next(o, n), r = this.states[o], r || (this.reportError("state doesn't exist", o), o = "start", r = this.states[o]), s = this.matchMappings[o], h = m, a = this.regExps[o], a.lastIndex = m);
                            break
                        }
                        if (p)if ("string" == typeof g)f && f.merge === !1 || d.type !== g ? (d.type && c.push(d), d = {
                            type: g,
                            value: p
                        }) : d.value += p; else if (g) {
            ...
            (function () {
                this.addRules = function (e, t) {
                    ...
                    if (this.addRules(s, t), n)for (var c = Array.prototype[r ? "push" : "unshift"], a = 0; a < o.length; a++)c.apply(this.$rules[o[a]], i.deepCopy(n));
            ...
            (function () {
                this.tokenRe = new RegExp("^[" + r.packages.L + r.packages.Mn + r.packages.Mc + r.packages.Nd + r.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + r.packages.L + r.packages.Mn + r.packages.Mc + r.packages.Nd + r.packages.Pc + "\\$_]|\\s])+", "g"), this.getTokenizer = function () {
                    ...
                    if (this.lineCommentStart) {
                        if (Array.isArray(this.lineCommentStart))var d = this.lineCommentStart.map(s.escapeRegExp).join("|"), g = this.lineCommentStart[0]; else var d = s.escapeRegExp(this.lineCommentStart), g = this.lineCommentStart;
                        ...
                        var f = function (e, t) {
                            ...
                            (!a || /\S/.test(e)) && (A(e, c, c) ? r.insertInLine({
                                row: t,
                                column: c
                            }, p) : r.insertInLine({row: t, column: c}, g))
                        }, v = function (e) {
                            return d.test(e)
                        }, A = function (e, t, i) {
                        ...
                        var g = this.blockComment.start, w = this.blockComment.end, d = new RegExp("^(\\s*)(?:" + s.escapeRegExp(g) + ")"), C = new RegExp("(?:" + s.escapeRegExp(w) + ")\\s*$"), m = function (e, t) {
                            v(e, t) || (!a || /\S/.test(e)) && (r.insertInLine({
                                row: t,
                                column: e.length
                            }, w), r.insertInLine({row: t, column: c}, g))
                        }, f = function (e, t) {
                            var i;
                    ...
                    }), c == 1 / 0 && (c = E, a = !1, l = !1), u && c % h != 0 && (c = Math.floor(c / h) * h), o(l ? f : m)
                }, this.toggleBlockComment = function (e, t, i, n) {
                    var o = this.blockComment;
                    if (o) {
                        !o.start && o[0] && (o = o[0]);
                        var r, s, c = new a(t, n.row, n.column), h = c.getCurrentToken(), u = (t.selection, t.selection.toOrientedRange());
            ...
            (function () {
                i.implement(this, n), this.setValue = function (e) {
                    ...
                    var i = {row: e.row + 1, column: 0}, n = {
                        action: "insertText",
                        range: o.fromPoints(e, i), text: this.getNewLineCharacter()
                    };
                    ...
                    var n = {row: e.row, column: e.column + t.length}, r = {
                        action: "insertText",
                    ...
                    if (e.isMultiLine()) {
                        var n = 0 == e.start.column ? t : t + 1, r = i - 1;
                    ...
                    var i = new o(e, 0, t + 1, 0), n = this.$lines.splice(e, t - e + 1), r = {
                        action: "removeLines",
                        range: i,
                    ...
                    for (var i = this.$lines || this.getAllLines(), n = this.getNewLineCharacter().length, o = t || 0, r = i.length; r > o; o++)if (e -= i[o].length + n, 0 > e)return {
                        row: o,
            ...
            (function () {
                this.shiftRow = function (e) {
                    ...
                    var o = n.fold, r = this.folds, s = this.foldData, a = r.indexOf(o), l = r[a - 1];
            ...
            function i() {
                this.getFoldAt = function (e, t, i) {
                    ...
                    var i, o;
                    if (null == e ? (i = new n(0, 0, this.getLength(), 0), t = !0) : i = "number" == typeof e ? new n(e, 0, e, this.getLine(e).length) : "row"in e ? n.fromPoints(e, e) : e, o = this.getFoldsInRangeList(i), t)this.removeFolds(o); else for (var r = o; r.length;)this.expandFolds(r), r = this.getFoldsInRangeList(i);
            ...
            "use strict";
            var i = e("./lib/oop"), n = e("./lib/lang"), o = e("./config"), r = e("./lib/event_emitter").EventEmitter, s = e("./selection").Selection, a = e("./mode/text").Mode, l = e("./range").Range, c = e("./document").Document, h = e("./background_tokenizer").BackgroundTokenizer, u = e("./search_highlight").SearchHighlight, d = function (e, t) {
            ...
            (function () {
                ...
                i.implement(this, r), this.setDocument = function (e) {
                    ...
                    var i, n, o = this.doc.getAllLines(), r = this.getTabSize(), s = this.$wrapData, a = this.$wrapLimit, l = e;
                ...
                var t = 1, s = 2, c = 3, d = 4, g = 9, f = 10, p = 11, m = 12;
                this.$computeWrapSplits = function (e, t) {
                    ...
                    for (var n = [], o = e.length, r = 0, a = 0, l = this.$wrapAsCode; o - r > t;) {
                        var h = r + t;
                        if (e[h - 1] >= f && e[h] >= f)i(h); else if (e[h] != c && e[h] != d) {
                            for (var u = Math.max(h - (l ? 10 : t - (t >> 2)), r - 1); h > u && e[h] < c;)h--;
                            if (l) {
                                for (; h > u && e[h] < c;)h--;
                                for (; h > u && e[h] == g;)h--
                            } else for (; h > u && e[h] < f;)h--;
                ...
                this.set = function (e) {
                    ...
                    if (t.$isMultiLine) {
                        ...
                        e:for (var u = a.offset || 0; h >= u; u++) {
                            for (var d = 0; c > d; d++)if (-1 == r[u + d].search(a[d]))continue e;
                            var g = r[u], f = r[u + c - 1], p = g.length - g.match(a[0])[0].length, m = f.match(a[c - 1])[0].length;
                            l && l.end.row === u && l.end.column > p || (s.push(l = new o(u, p, u + c - 1, m)), c > 2 && (u = u + c - 2))
                        }
                    } else for (var v = 0; v < r.length; v++)for (var A = i.getMatchOffsets(r[v], a), d = 0; d < A.length; d++) {
                        var w = A[d];
                        s.push(new o(v, w.offset, v, w.offset + w.length))
                    }
                    if (n) {
                    ...
                    if (t.$isMultiLine)var l = n.length, c = function (t, i, s) {
                        ...
                        if (-1 != a) {
                            ...
                            var h = t.match(n[l - 1])[0].length, u = new o(i, a, i + l - 1, h);
                        ...
                        for (var s = i.getMatchOffsets(e, n), a = s.length - 1; a >= 0; a--)if (r(s[a], t, o))return !0
                    }; else var c = function (e, t, o) {
                        for (var s = i.getMatchOffsets(e, n), a = 0; a < s.length; a++)if (r(s[a], t, o))return !0
                    };
                    return {
                        forEach: function (i) {
            ...
            n.prototype = i.prototype, function () {
                this.addCommand = function (e) {
                    ...
                    return "object" == typeof e && (e = e[this.platform]), e ? "function" == typeof t ? this.addCommand({
                        ...
                        if (-1 != e.indexOf(" ")) {
                            ...
                            e = o.pop(), o.forEach(function (e) {
                                var t = this.parseKeys(e), i = s[t.hashId] + t.key;
                    ...
                    var o = s[t] + i, r = this.commandKeyBinding[o];
            ...
            "use strict";
            var i = e("../lib/oop"), n = e("../keyboard/hash_handler").MultiHashHandler, o = e("../lib/event_emitter").EventEmitter, r = function (e, t) {
            ...
            var n = e("../lib/lang"), o = e("../config"), r = e("../range").Range;
            t.commands = [{
            ...
            var i = e("./lib/oop"), n = e("./lib/dom"), o = e("./lib/lang"), r = e("./lib/useragent"), s = e("./keyboard/textinput").TextInput, a = e("./mouse/mouse_handler").MouseHandler, l = e("./mouse/fold_handler").FoldHandler, c = e("./keyboard/keybinding").KeyBinding, h = e("./edit_session").EditSession, u = e("./search").Search, d = e("./range").Range, g = e("./lib/event_emitter").EventEmitter, f = e("./commands/command_manager").CommandManager, p = e("./commands/default_commands").commands, m = e("./config"), v = e("./token_iterator").TokenIterator, A = function (e, t) {
                ...
                i.implement(this, g), this.$initOperationListeners = function () {
                    ...
                    if (this.session.$bracketHighlight && (this.session.removeMarker(this.session.$bracketHighlight), this.session.$bracketHighlight = null), !this.$highlightPending) {
                        ...
                        this.$highlightPending = !0, setTimeout(function () {
                            ...
                            if (t && t.bgTokenizer) {
                                ...
                                if (i)var n = new d(i.row, i.column, i.row, i.column + 1); else if (t.$mode.getMatching)var n = t.$mode.getMatching(e.session);
                    ...
                    if (!this.$highlightTagPending) {
                        ...
                        this.$highlightTagPending = !0, setTimeout(function () {
                            ...
                            var t = e.session;
                            if (t && t.bgTokenizer) {
                                var i = e.getCursorPosition(), n = new v(e.session, i.row, i.column), o = n.getCurrentToken();
                                ...
                                var l = n.getCurrentTokenRow(), c = n.getCurrentTokenColumn(), h = new d(l, c, l, c + o.value.length);
                    ...
                    if (this.session.getUseSoftTabs())var c = a - l % a, h = o.stringRepeat(" ", c);
                    else {
                    ...
                    var t = this.selection.getCursor().row, i = this.selection.getCursor().column, n = new d(t, i - 1, t, i), o = this.session.getTextRange(n);
                    ...
                    var i = this.getCursorPosition(), n = new v(this.session, i.row, i.column), o = n.getCurrentToken(), r = o || n.stepForward();
                    if (r) {
                        ...
                        if (s) {
                            var g, f;
                            if ("bracket" === s)g = this.session.getBracketRange(i), g || (g = new d(n.getCurrentTokenRow(), n.getCurrentTokenColumn() + h - 1, n.getCurrentTokenRow(), n.getCurrentTokenColumn() + h - 1), f = g.start, (t || f.row === i.row && Math.abs(f.column - i.column) < 2) && (g = this.session.getBracketRange(f))); else if ("tag" === s) {
            ...
            (function () {
                this.$padding = 0, this.setPadding = function (e) {
                    ...
                    var s = t.start.row, a = new i(s, t.start.column, s, this.session.getScreenLastRowColumn(s));
            ...
            "use strict";
            var i = e("../lib/oop"), n = e("../lib/dom"), o = e("../lib/lang"), r = (e("../lib/useragent"), e("../lib/event_emitter").EventEmitter), s = function (e) {
            ...
            (function () {
                i.implement(this, r), this.EOF_CHAR = "¶", this.EOL_CHAR_LF = "¬", this.EOL_CHAR_CRLF = "¤", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "→", this.SPACE_CHAR = "·", this.$padding = 0, this.$updateEolChar = function () {
                    ...
                    for (var o = this.element.ownerDocument.createDocumentFragment(), r = t, s = this.session.getNextFoldLine(r), a = s ? s.start.row : 1 / 0; ;) {
                        ...
                        if (this.$renderLine(c, r, !1, r == a ? s : !1), l.innerHTML = c.join(""), this.$useLineGroups())l.className = "ace_line_group", o.appendChild(l), l.style.height = e.lineHeight * this.session.getRowLength(r) + "px"; else for (; l.firstChild;)o.appendChild(l.firstChild);
                        r++
                    }
                    return o
                }, this.update = function (e) {
                    ...
                    var r = this, s = /\t|&|<|( +)|([\x00-\x1f\x80-\xa0\xad\u1680\u180E\u2000-\u200f\u2028\u2029\u202F\u205F\u3000\uFEFF])|[\u1100-\u115F\u11A3-\u11A7\u11FA-\u11FF\u2329-\u232A\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFB\u3000-\u303E\u3041-\u3096\u3099-\u30FF\u3105-\u312D\u3131-\u318E\u3190-\u31BA\u31C0-\u31E3\u31F0-\u321E\u3220-\u3247\u3250-\u32FE\u3300-\u4DBF\u4E00-\uA48C\uA490-\uA4C6\uA960-\uA97C\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFAFF\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE66\uFE68-\uFE6B\uFF01-\uFF60\uFFE0-\uFFE6]/g, a = function (e, i, n, s) {
            ...
            var i = e("../lib/oop"), n = e("../lib/dom"), o = e("../lib/lang"), r = e("../lib/useragent"), s = e("../lib/event_emitter").EventEmitter, a = 0, l = t.FontMetrics = function (e) {
            ...
            (function () {
                i.implement(this, s), this.$characterSize = {
                    ...
                    } else var i = {height: this.$measureNode.clientHeight, width: this.$measureNode.clientWidth / a};
            ...
            (function () {
                this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, i.implement(this, f), this.updateCharacterSize = function () {
                    ...
                    return this.layerConfig.width != a && (C = this.CHANGE_H_SCROLL), (c || d) && (C = this.$updateCachedSize(!0, this.gutterWidth, t.width, t.height), this._signal("scrollbarVisibilityChanged"), d && (a = this.$getLongestLine())), this.layerConfig = {
                        ...
                        maxHeight: o,
                        offset: r,
                        gutterOffset: Math.max(0, Math.ceil((r + t.height - t.scrollerHeight) / A)),
                    ...
                    function i(i) {
                        ...
                        if (i.cssClass) {
                            ...
                            r.$padding && o != r.$padding && r.setPadding(o), r.$theme = i.cssClass, r.theme = i, n.addCssClass(r.container, i.cssClass), n.setCssClass(r.container, "ace_dark", i.isDark), r.$size && (r.$size.width = 0, r.$updateSizeAsync()), r._dispatchEvent("themeLoaded", {theme: i}), t && t()
                        }
                    }

                    var r = this;
                    if (this.$themeId = e, r._dispatchEvent("themeChange", {theme: e}), e && "string" != typeof e)i(e); else {
            ...
            "use strict";
            var n = e("../lib/oop"), o = e("../lib/net"), r = e("../lib/event_emitter").EventEmitter, s = e("../config"), a = function (t, n, o, r) {
                if (this.$sendDeltaQueue = this.$sendDeltaQueue.bind(this), this.changeListener = this.changeListener.bind(this), this.onMessage = this.onMessage.bind(this), e.nameToUrl && !e.toUrl && (e.toUrl = e.nameToUrl), s.get("packaged") || !e.toUrl)r = r || s.moduleUrl(n.id, "worker"); else {
            ...
            var l = function (e, t, i) {
                ...
                var n = null, o = !1, a = Object.create(r), l = this;
            ...
            function n(e) {
                ...
                if (0 === c) {
                    var h, u = e.editor, d = u.selection, g = u.inMultiSelectMode, f = e.getDocumentPosition(), p = d.getCursor(), m = e.inSelection() || d.isEmpty() && i(f, p), v = e.x, A = e.y, w = function (e) {
                        v = e.clientX, A = e.clientY
                    }, C = u.session, E = u.renderer.pixelToScreenCoordinates(v, A), F = E;
                    if (u.$mouseHandler.$enableJumpToDef)a && n || l && n ? h = "add" : n && (h = "block"); else if (l && !n) {
                        if (h = "add", !g && s)return
                    } else n && (h = "block");
                    if (h && r.isMac && t.ctrlKey && u.$mouseHandler.cancelContextMenu(), "add" == h) {
                        ...
                        u.$blockScrolling++, u.inVirtualSelectionMode = !0, s && (b = null, y = d.ranges[0], u.removeSelectionMarker(y)), u.once("mouseup", function () {
                            var e = d.toOrientedRange();
                            b && e.isEmpty() && i(b.cursor, e.cursor) ? d.substractPoint(e.cursor) : (s ? d.substractPoint(y.cursor) : y && (u.removeSelectionMarker(y), d.addRange(y)), d.addRange(e)), u.$blockScrolling--, u.inVirtualSelectionMode = !1
                        })
                    } else if ("block" == h) {
                        ...
                        var x, S = [], $ = function () {
                            ...
                            i(F, e) && i(t, d.lead) || (F = e, u.selection.moveToPosition(t), u.renderer.scrollCursorIntoView(), u.removeSelectionMarkers(S), S = d.rectangularRangeBlock(F, E), u.$mouseHandler.$clickSelection && 1 == S.length && S[0].isEmpty() && (S[0] = u.$mouseHandler.$clickSelection.clone()), S.forEach(u.addSelectionMarker, u), u.updateSelectionMarkers())
                        };
                        g && !l ? d.toSingleRange() : !g && l && (x = d.toOrientedRange(), u.addSelectionMarker(x)), s ? E = C.documentToScreenPosition(d.lead) : d.moveToPosition(f), F = {
                            row: -1,
                            column: -1
                        };
                        var B = function () {
            ...
            (function () {
                ...
                this.ranges = null, this.rangeList = null, this.addRange = function (e, t) {
                    ...
                    if (this.rangeCount > 1) {
                        ...
                        if (o == r) {
                            if (n)var s = i.end, l = i.start; else var s = i.start, l = i.end;
            ...
            (function () {
                this.updateSelectionMarkers = function () {
                    ...
                    if (!this.inVirtualSelectionMode) {
                        var n, o = i && i.keepOrder, r = 1 == i || i && i.$byLines, s = this.session, a = this.selection, c = a.rangeList, h = (o ? a : c).ranges;
                    ...
                    if (i.isEmpty())var s = r; else var l = this.session.documentToScreenPosition(n ? i.end : i.start), s = this.session.screenToDocumentPosition(l.row + e, l.column);
                    if (n) {
                    ...
                    if (!s.isEmpty() || (s = o.getWordRange(s.start.row, s.start.column), s.cursor = -1 == e ? s.start : s.end, this.multiSelect.addRange(s), !n)) {
                        var a = o.getTextRange(s), l = i(o, a, e);
            ...
            function n(e, t, n) {
                ...
                if (o.length) {
                    var r = i(o, {row: t, column: -1}, s.comparePoints);
            ...
            t.showErrorMarker = function (e, t) {
                ...
                var s = e.getCursorPosition(), a = s.row, l = i.lineWidgets && i.lineWidgets[a];
                l ? l.destroy() : a -= t;
                var c, h = n(i, a, t);
                if (h) {
                    var u = h[0];
            ...
            "use strict";
            e("./lib/fixoldbrowsers");
            var i = e("./lib/dom"), n = e("./lib/event"), o = e("./editor").Editor, r = e("./edit_session").EditSession, s = e("./undomanager").UndoManager, a = e("./virtual_renderer").VirtualRenderer;
        ...
        ace.define("ace/mode/json_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t) {
            ...
            "use strict";
            var i, n = e("../../lib/oop"), o = e("../behaviour").Behaviour, r = e("../../token_iterator").TokenIterator, s = e("../../lib/lang"), a = ["text", "paren.rparen", "punctuation.operator"], l = ["text", "paren.rparen", "punctuation.operator", "comment"], c = {}, h = function (e) {
                var t = -1;
                return e.multiSelect && (t = e.selection.index, c.rangeCount != e.multiSelect.rangeCount && (c = {rangeCount: e.multiSelect.rangeCount})), c[t] ? i = c[t] : void(i = c[t] = {
                ...
                this.add("braces", "insertion", function (e, t, n, o, r) {
                    ...
                    if ("{" == r) {
                        h(n);
                        var c = n.getSelectionRange(), d = o.doc.getTextRange(c);
                        ...
                        if (u.isSaneInsertion(n, o))return /[\]\}\)]/.test(l[a.column]) || n.inMultiSelectMode ? (u.recordAutoInsert(n, o, "}"), {
                            text: "{}",
                            selection: [1, 1]
                        }) : (u.recordMaybeInsert(n, o, "{"), {text: "{", selection: [1, 1]})
                    } else if ("}" == r) {
                        h(n);
                    ...
                    if ("(" == o) {
                        ...
                        if (")" == c) {
                            var d = n.$findOpeningBracket(")", {column: a.column + 1, row: a.row});
                    ...
                    if ('"' == o || "'" == o) {
                        ...
                        var l = i.getCursorPosition(), c = n.doc.getLine(l.row), d = c.substring(l.column - 1, l.column);
                        if ("\\" == d)return null;
            ...
            "use strict";
            var i = e("../../lib/oop"), n = e("../../range").Range, o = e("./fold_mode").FoldMode, r = t.FoldMode = function (e) {
            ...
            "use strict";
            var n = e("../lib/oop"), o = e("./text").Mode, r = e("./json_highlight_rules").JsonHighlightRules, s = e("./matching_brace_outdent").MatchingBraceOutdent, a = e("./behaviour/cstyle").CstyleBehaviour, l = e("./folding/cstyle").FoldMode, c = e("../worker/worker_client").WorkerClient, h = function () {
                this.HighlightRules = r, this.$outdent = new s, this.$behaviour = new a, this.foldingRules = new l
            };
            n.inherits(h, o), function () {
                this.getNextLineIndent = function (e, t, i) {
                    ...
                    var t = new c(["ace"], i(17), "JsonWorker");
            ...
            (function () {
                this.setEditor = function (e) {
                    ...
                    o.addListener(e, "mousedown", function (e) {
                        ...
                        var r = a.keyCodeToString(n), s = t.$searchBarKb.findKeyCommand(i, r);
                    ...
                    i.setCssClass(this.searchBox, "ace_nomatch", t), this.editor._emit("findSearchBox", {match: !t}), this.highlight(), this.hide()
